...
namespace AdobeHDS
{
	public class F4F
	{
		...
		public void InitDecoder()
		{
			...
			this.baseTS            = Defines.INVALID_TIMESTAMP;
			this.negTS             = Defines.INVALID_TIMESTAMP;
			this.prevAudioTS       = Defines.INVALID_TIMESTAMP;
			this.prevVideoTS       = Defines.INVALID_TIMESTAMP;
			this.pAudioTagLen      = 0;
			this.pVideoTagLen      = 0;
			this.pAudioTagPos      = 0;
			this.pVideoTagPos      = 0;
		...
		function ParseManifest(cCURL cc, string parentManifest)
		{
